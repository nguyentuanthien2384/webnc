...
**Dashboard** hiển thị nội dung theo vai trò. USER xem hoạt động và tài liệu của chính mình; MODERATOR và ADMIN xem chỉ số nền tảng, xu hướng đăng tài liệu theo 7/30/90 ngày, báo cáo chờ xử lý và các mục quản trị tương ứng. Nút **Làm mới** cập nhật dữ liệu; các phần hiển thị trạng thái tải, lỗi và cách thử lại riêng. Xem [chi tiết quyền USER, MODERATOR và ADMIN](../PHAN_QUYEN.md).
